...
import NestedList_level3 from './NesterList_level3';
export default class NestedList_level2 extends Component {
  ...
  render() {
    ...
    return (
      ...
      <List
        ...
        <ListItem button onClick={()=>handleClick("open1")} id='level2' >
          <ListItemIcon>
          ...
          <List component="div" disablePadding>
            {
              Object.keys(full_dropdown_list).map(experiment => {
                ...
                return(<NestedList_level3 element={experiment} experiments={full_dropdown_list[experiment]}/>)
              })
            }
          </List>
        </Collapse>
