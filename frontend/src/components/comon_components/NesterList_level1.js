...
import NestedList_level2 from './NesterList_level2';

export default class NestedList_level1 extends Component {
  ...
  render() {
    ...
    return (
      <List
        ...
        <ListItem button onClick={()=>handleClick("open1")} id='level1'>
          <ListItemIcon>
        ...
        <Collapse in={this.state["open1"]} timeout="auto" unmountOnExit>
          {Object.keys(full_dropdown_list).map(experiment => {
            ...
            return(<NestedList_level2 element={experiment} experiments={full_dropdown_list[experiment]}/>)
          })
        }
